...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add stability or adm power = yes</li><li>add dip power = 25</li><li>set country flag [trader](../flags/trader.md)</li></ul>
...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add prestige = 50</li><li>add dip power = 25</li><li>set country flag [trader](../flags/trader.md)</li></ul>
