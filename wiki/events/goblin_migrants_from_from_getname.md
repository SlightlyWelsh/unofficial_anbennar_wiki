#Information
 - Title: Goblin Migrants From [From.GetName]
 - ID: racial_pop_events_goblin.9
#Description
Goblin Migrants From [From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>add years of income = 0.1</li><li>event target:racial pop province target:</li><ul><li>add goblin minority size effect = yes</li></ul><li>If has has large goblin minority trigger is yes, and has goblin majority trigger is yes:</li><ul><li>event target:racial pop province target:</li><ul><li>random:</li><ul><li>chance = 50</li><li>add base production = 1</li></ul></ul></ul><li>small decrease of goblin tolerance effect = yes</li></ul>
...
###Efects:<ul><li>add mil power = -10</li><li>small decrease of goblin tolerance effect = yes</li></ul>
