...
___
##We need reparations for this outrage
...
AI weights this option at 30
 ...
 - Multiplied by 3 if does not have check variable has which is enuuk resolve, and check variable has which is kodave resolve


###Efects:<ul><li>add prestige = 2</li><li>add mil power = -10</li><li>increase enuuk resolve 1 = yes</li></ul>

___
##We must dodge a bloodbath
...
AI weights this option at 30
 ...
 - Multiplied by 3 if has REB has check variable has which is enuuk resolve, and check variable has which is kodave resolve


###Efects:<ul><li>add prestige = 2</li><li>add dip power = -10</li><li>decrease enuuk resolve 1 = yes</li></ul>
...
The following pages have the same name as this page:
 - [rattle_our_saber_1](rattle_our_saber_1.md)
