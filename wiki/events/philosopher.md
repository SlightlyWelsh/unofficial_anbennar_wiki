...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add stability or adm power = yes</li><li>set country flag [philosopher](../flags/philosopher.md)</li></ul>
...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add prestige = 50</li><li>set country flag [philosopher](../flags/philosopher.md)</li></ul>
