#Information
 - Title: Kobold Minority Expelled
 - ID: racial_pop_events_kobold.17
#Description
Kobold Minority Expelled
#Mean Time to Happen:
Base time = 1825 days
...
###Efects:<ul><li>highlight = yes</li><li>event target:racial pop province origin:</li><ul><li>remove kobold minority size effect = yes</li><li>add devastation = 10</li></ul><li>If does not have low tolerance kobold race trigger is yes:</li><ul><li>event target:racial pop migration country:</li><ul><li>the event ˻racial_pop_events_kobold.10˼ happens</li></ul></ul><li>If has event target:racial pop province origin has development is 20:</li><ul><li>add treasury = 50</li></ul><li>else:</li><ul><li>add treasury = 10</li></ul><li>medium decrease of kobold tolerance effect = yes</li></ul>
