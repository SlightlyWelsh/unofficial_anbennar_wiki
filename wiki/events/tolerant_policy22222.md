This page has the same name as others. For full listing see bottom of [the base page](tolerant.md).
...
Base time = 5000 months
 ...
 - Multiplied by 0.95 if has any neighbor province has religion is sunni
...
###Efects:<ul><li>change religion = sunni</li><li>owner:</li><ul><li>add piety = -0.10</li></ul></ul>


#Pages with same name:
The following pages have the same name as this page:
 - [tolerant_policy22222_1](tolerant_policy22222_1.md)
