...
###Efects:<ul><li>custom tooltip = pop_menu_expel_desc_tt</li><li>remove country modifier = racial_pop_gnollish_expulsion</li><li>add adm power = -50</li><li>hidden effect:</li><ul><li>If is not controlled by the AI:</li><ul><li>the event [Missing localisation: racial_pop_events_gnollish_24_t](../events/missing_localisation_racial_pop_events_gnollish_24_t.md) happens</li></ul><li>else:</li><ul><li>clr country flag [racial_pop_menu_opened](../flags/racial_pop_menu_opened.md)</li></ul><li>the event [Revocation of Expulsion of Gnollkind](../events/revocation_of_expulsion_of_gnollkind.md) happens</li></ul></ul>

___
##£event_button_cant_cancel_expel£

###Available if:
<li>has country modifier racial_pop_gnollish_expulsion</li><li>None of the following:</li><ul><li>adm power is at least 50</li></ul>

###AI weighting:
AI weights this option at 0


###Efects:<ul><li>custom tooltip = pop_menu_expel_desc_tt</li><li>custom tooltip = pop_menu_cannot_stop_expel_not_enough_adm_tt</li><li>hidden effect:</li><ul><li>the event [Missing localisation: racial_pop_events_gnollish_24_t](../events/missing_localisation_racial_pop_events_gnollish_24_t.md) happens</li></ul></ul>
...
###Efects:<ul><li>custom tooltip = pop_menu_focus_desc_tt</li><li>add dip power = -50</li><li>country gets the modifier racial_focus_gnollish until otherwise removed</li><li>hidden effect:</li><ul><li>the event [Missing localisation: racial_pop_events_gnollish_24_t](../events/missing_localisation_racial_pop_events_gnollish_24_t.md) happens</li></ul></ul>

___
##£event_button_cant_enact_focus£

###Available if:
<li>None of the following:</li><ul><li>has country modifier racial_focus_gnollish</li></ul><li>Any of the following:</li><ul><li>None of the following:</li><ul><li>dip power is at least 50</li></ul><li>has racial focus yes</li></ul>
