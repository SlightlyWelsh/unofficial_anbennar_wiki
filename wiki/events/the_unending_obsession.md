...
___
##I will indulge, but only a little

###Available if:
<li>mil is at least 1</li>

###AI weighting:
AI weights this option at 10


###Efects:<ul><li>the event ˻vampire_ruler.13˼ happens</li><li>change mil = -2</li><li>set country flag [vampire_missed_hunt](../flags/vampire_missed_hunt.md)</li></ul>

___
##I will control myself

###Available if:
<li>mil is at least 1</li><li>None of the following:</li><ul><li>has country flag [vampire_missed_hunt](../flags/vampire_missed_hunt.md)</li></ul>
...
This outcome causes the following effects:<ul><li>change mil = -2</li></ul>
Outcome 2:
