#Information
 - Title: Gnomish Refugees From [From.From.GetName]
 - ID: racial_pop_events_gnomish.11
#Description
Gnomish Refugees From [From.From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>random:</li><ul><li>chance = 50</li><li>event target:racial pop province target:</li><ul><li>add gnomish minority size effect = yes</li><li>add local autonomy = 10</li></ul><li>If has has large gnomish minority trigger is yes, and has gnomish majority trigger is yes:</li><ul><li>event target:racial pop province target:</li><ul><li>random:</li><ul><li>chance = 50</li><li>add base production = 1</li></ul></ul></ul></ul><li>add mil power = -30</li><li>large decrease of gnomish tolerance effect = yes</li></ul>
