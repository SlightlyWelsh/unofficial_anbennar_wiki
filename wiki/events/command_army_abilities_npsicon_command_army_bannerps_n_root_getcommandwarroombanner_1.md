This page has the same name as others. For full listing see bottom of [the base page](command_army_abilities_npsicon_command_army_bannerps_n_root_getcommandwarroombanner.md).
