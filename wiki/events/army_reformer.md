...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add stability or adm power = yes</li><li>country gets the modifier "land_investment" for 6 years</li><li>set country flag [army_reformer](../flags/army_reformer.md)</li></ul>
...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add prestige = 50</li><li>country gets the modifier "land_investment" for 6 years</li><li>set country flag [army_reformer](../flags/army_reformer.md)</li></ul>
