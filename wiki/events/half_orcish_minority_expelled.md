#Information
 - Title: Half-orcish Minority Expelled
 - ID: racial_pop_events_half_orcish.17
#Description
Half-orcish Minority Expelled
#Mean Time to Happen:
Base time = 1825 days
...
###Efects:<ul><li>highlight = yes</li><li>event target:racial pop province origin:</li><ul><li>remove half orcish minority size effect = yes</li><li>add devastation = 10</li></ul><li>If does not have low tolerance half orcish race trigger is yes:</li><ul><li>event target:racial pop migration country:</li><ul><li>the event [Half-orcish Refugees From [From.GetName]](../events/half_orcish_refugees_from_from_getname.md) happens</li></ul></ul><li>If has event target:racial pop province origin has development is 20:</li><ul><li>add treasury = 50</li></ul><li>else:</li><ul><li>add treasury = 10</li></ul><li>medium decrease of half orcish tolerance effect = yes</li></ul>
