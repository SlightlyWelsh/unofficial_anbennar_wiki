#Information
 - Title: Halfling Refugees From [From.From.GetName]
 - ID: racial_pop_events_halfling.11
#Description
Halfling Refugees From [From.From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>random:</li><ul><li>chance = 50</li><li>event target:racial pop province target:</li><ul><li>add halfling minority size effect = yes</li><li>add local autonomy = 10</li></ul><li>If has has large halfling minority trigger is yes, and has halfling majority trigger is yes:</li><ul><li>event target:racial pop province target:</li><ul><li>random:</li><ul><li>chance = 50</li><li>add base production = 1</li></ul></ul></ul></ul><li>add mil power = -30</li><li>large decrease of halfling tolerance effect = yes</li></ul>
