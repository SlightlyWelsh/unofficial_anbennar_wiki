#Information
 - Title: Troll Refugees From [From.GetName]
 - ID: racial_pop_events_troll.10
#Description
Troll Refugees From [From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>If does not have country modifier is racial pop troll purge; and does not have country modifier is racial pop troll expulsion:</li><ul><li>event target:racial pop migration country:</li><ul><li>the event ˻racial_pop_events_troll.11˼ happens</li></ul></ul><li>add mil power = -20</li><li>medium decrease of troll tolerance effect = yes</li></ul>
