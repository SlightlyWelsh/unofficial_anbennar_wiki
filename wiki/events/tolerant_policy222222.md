...
Base time = 5000 months
 ...
 - Multiplied by 0.95 if has any neighbor province has religion is sikhism
...
###Efects:<ul><li>change religion = sikhism</li></ul>


#Pages with same name:
The following pages have the same name as this page:
 - [tolerant_policy222222_1](tolerant_policy222222_1.md)
