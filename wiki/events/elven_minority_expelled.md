#Information
 - Title: Elven Minority Expelled
 - ID: racial_pop_events_elven.17
#Description
Elven Minority Expelled
#Mean Time to Happen:
Base time = 1825 days
...
###Efects:<ul><li>highlight = yes</li><li>event target:racial pop province origin:</li><ul><li>remove elven minority size effect = yes</li><li>add devastation = 10</li></ul><li>If does not have low tolerance elven race trigger is yes:</li><ul><li>event target:racial pop migration country:</li><ul><li>the event [Elven Refugees From [From.GetName]](../events/elven_refugees_from_from_getname.md) happens</li></ul></ul><li>If has event target:racial pop province origin has development is 20:</li><ul><li>add treasury = 50</li></ul><li>else:</li><ul><li>add treasury = 10</li></ul><li>medium decrease of elven tolerance effect = yes</li></ul>
