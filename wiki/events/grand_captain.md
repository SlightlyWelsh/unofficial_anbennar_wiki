...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add stability or adm power = yes</li><li>country gets the modifier "grand_captain_boost" for 6 years</li><li>set country flag [grand_captain](../flags/grand_captain.md)</li></ul>
...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add prestige = 50</li><li>country gets the modifier "grand_captain_boost" for 6 years</li><li>set country flag [grand_captain](../flags/grand_captain.md)</li></ul>
