#Information
 - Title: Kobold Refugees From [From.From.GetName]
 - ID: racial_pop_events_kobold.11
#Description
Kobold Refugees From [From.From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>random:</li><ul><li>chance = 50</li><li>event target:racial pop province target:</li><ul><li>add kobold minority size effect = yes</li><li>add local autonomy = 10</li></ul><li>If has has large kobold minority trigger is yes, and has kobold majority trigger is yes:</li><ul><li>event target:racial pop province target:</li><ul><li>random:</li><ul><li>chance = 50</li><li>add base production = 1</li></ul></ul></ul></ul><li>add mil power = -30</li><li>large decrease of kobold tolerance effect = yes</li></ul>
