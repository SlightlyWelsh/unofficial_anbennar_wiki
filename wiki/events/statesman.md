...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add stability or adm power = yes</li><li>country gets the modifier "government_investment" for 6 years</li><li>set country flag [statesman](../flags/statesman.md)</li></ul>
...
###Efects:<ul><li>add meritocracy effect = yes</li><li>add prestige = 50</li><li>country gets the modifier "government_investment" for 6 years</li><li>set country flag [statesman](../flags/statesman.md)</li></ul>
