#Information
 - Title: Ogre Refugees From [From.GetName]
 - ID: racial_pop_events_ogre.10
#Description
Ogre Refugees From [From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>event target:racial pop province target:</li><ul><li>add ogre minority size effect = yes</li><li>add local autonomy = 10</li></ul><li>If has has large ogre minority trigger is yes, and has ogre majority trigger is yes:</li><ul><li>event target:racial pop province target:</li><ul><li>random:</li><ul><li>chance = 50</li><li>add base production = 1</li></ul></ul></ul><li>small increase of ogre tolerance effect = yes</li></ul>
...
###Efects:<ul><li>add years of income = 0.2</li><li>event target:racial pop province target:</li><ul><li>add ogre minority size effect = yes</li><li>add local autonomy = 10</li></ul><li>If has has large ogre minority trigger is yes, and has ogre majority trigger is yes:</li><ul><li>event target:racial pop province target:</li><ul><li>random:</li><ul><li>chance = 50</li><li>add base production = 1</li></ul></ul></ul><li>medium decrease of ogre tolerance effect = yes</li></ul>
...
###Efects:<ul><li>If does not have country modifier is racial pop ogre purge; and does not have country modifier is racial pop ogre expulsion:</li><ul><li>event target:racial pop migration country:</li><ul><li>the event [Ogre Refugees From [From.From.GetName]](../events/ogre_refugees_from_from_from_getname.md) happens</li></ul></ul><li>add mil power = -20</li><li>medium decrease of ogre tolerance effect = yes</li></ul>
