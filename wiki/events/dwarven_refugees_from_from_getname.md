#Information
 - Title: Dwarven Refugees From [From.GetName]
 - ID: racial_pop_events_dwarven.10
#Description
Dwarven Refugees From [From.GetName]
#Mean Time to Happen:
Base time = 1 days
...
###Efects:<ul><li>If does not have country modifier is racial pop dwarven purge; and does not have country modifier is racial pop dwarven expulsion:</li><ul><li>event target:racial pop migration country:</li><ul><li>the event [Dwarven Refugees From [From.From.GetName]](../events/dwarven_refugees_from_from_from_getname.md) happens</li></ul></ul><li>add mil power = -20</li><li>medium decrease of dwarven tolerance effect = yes</li></ul>
